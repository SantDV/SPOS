...
namespace SGV2
{
    public partial class Principal : Form
    {
        ...
        string comerceName = string.Empty;
        ...
        private void storeDataLoader() {
            ...
            DataTable datos = con.storeDataLoader();
        ...
        private void Imprimir(object sender, PrintPageEventArgs e)
        {
            ...
            Font fontTitles = new Font("Arial", 16, FontStyle.Bold, GraphicsUnit.Point, 0);
            Font fontProducts = new Font("Arial", 10, FontStyle.Regular, GraphicsUnit.Point, 0);
            Font fontTotalTicket = new Font("Arial", 12, FontStyle.Regular, GraphicsUnit.Point, 0);





            e.Graphics.DrawString($"{comerceName}", fontTitles, Brushes.Black, new RectangleF(50, y, 500, 25));

            y += 50;


            e.Graphics.DrawString($"CIUT    {cuit}", fontTotalTicket, Brushes.Black, new RectangleF(0, y, 600, 20));
            y += 20;
            e.Graphics.DrawString($"address   {address}", fontTotalTicket, Brushes.Black, new RectangleF(0, y, 600, 20));
            y += 20;
            e.Graphics.DrawString($"Ticket Nº   {idTicket}", fontTotalTicket, Brushes.Black, new RectangleF(0, y, 600, 20));
            y += 40;



            e.Graphics.DrawString(" ---------------------------------------------------------------", fontTotalTicket, Brushes.Black, new RectangleF(0, y, 600, 20));
            y += 20;
            foreach (DataGridViewRow row in dgvLProductlist.Rows)
            {
                ...
                e.Graphics.DrawString(" " + cantidad + "x", fontProducts, Brushes.Black, new RectangleF(0, y, 500, 20));
                ...
                if (producto.Length > 20)
                {
                    ...
                    e.Graphics.DrawString(primeraParte, fontProducts, Brushes.Black, new RectangleF(60, y, 500, 20));
                    y += 15;
                    e.Graphics.DrawString(segundaParte, fontProducts, Brushes.Black, new RectangleF(60, y, 500, 20));

                }
                else { e.Graphics.DrawString(producto, fontProducts, Brushes.Black, new RectangleF(60, y, 500, 20)); }


                e.Graphics.DrawString(subTotal, fontProducts, Brushes.Black, new RectangleF(300, y, 500, 20));
            ...
            e.Graphics.DrawString(" IVA RESPONSABLE INSCRIPTO", fontTotalTicket, Brushes.Black, new RectangleF(0, y, 500, 20));
            y += 20;
            e.Graphics.DrawString(" A CONSUMIDOR FINAL", fontTotalTicket, Brushes.Black, new RectangleF(0, y, 500, 20));
            y += 20;
            e.Graphics.DrawString(" Hora:   " + DateAndTime.TimeString, fontTotalTicket, Brushes.Black, new RectangleF(0, y, 500, 20));
            y += 20;
            e.Graphics.DrawString(" Fecha:  " + DateAndTime.DateString, fontTotalTicket, Brushes.Black, new RectangleF(0, y, 500, 20));
            y += 20;
            ...
            e.Graphics.DrawString(" Total articulos: ", fontTotalTicket, Brushes.Black, new RectangleF(0, y, 500, 20));
            e.Graphics.DrawString(productCount.ToString(), fontTotalTicket, Brushes.Black, new RectangleF(300, y, 500, 20));
            y += 20;

            e.Graphics.DrawString(" TOTAL: ", fontTotalTicket, Brushes.Black, new RectangleF(0, y, 500, 20));
            e.Graphics.DrawString(totalTicket, fontTotalTicket, Brushes.Black, new RectangleF(300, y, 500, 20));
            y += 20;

            e.Graphics.DrawString(" =====================================", fontTotalTicket, Brushes.Black, new RectangleF(0, y, 600, 20));

            e.Graphics.DrawString("¡GRACIAS POR SU COMPRA!", fontTitles, Brushes.Black, new RectangleF(30, y + 50, 500, 25));
